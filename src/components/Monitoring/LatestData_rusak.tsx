...
// Use the Vessel type from the shared types
...
export default function DailyReport() {
  ...
  // Ambil data vessel dari backend saat mount
  useEffect(() => {
    setLoading(true);
  ...
  // Ambil data hourly setiap kali vessel atau tanggal berubah
  useEffect(() => {
    let isMounted = true;
    if (selectedVessel && selectedDate) {
      generateHourlyData(selectedVessel).then(result => {
